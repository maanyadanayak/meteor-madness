    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-neon": {
          ...
          "100%": {
            "box-shadow": "0 0 30px hsl(var(--neon-green) / 0.8), 0 0 40px hsl(var(--neon-cyan) / 0.4)",
          },
        },
        "twinkle": {
      ...
      animation: {
        ...
        "meteor-streak": "meteor-streak 3s ease-out infinite",
      ...
      backgroundImage: {
        ...
        "gradient-meteor": "var(--gradient-meteor)",
      },
    },
  },
